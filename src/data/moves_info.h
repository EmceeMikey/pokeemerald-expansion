...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_MOONLIGHT] =
    {
        ...
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES >= GEN_6 ? TYPE_ASTRAL : TYPE_NORMAL,
        .accuracy = 0,
        .pp = 5,
        .target = MOVE_TARGET_USER,
        .priority = 0,
    ...
    [MOVE_PSYCHO_BOOST] =
    {
        .name = COMPOUND_STRING("Nuclear Boost"),
        .description = COMPOUND_STRING(
            "Allows a full-power attack,\n"
            "but sharply lowers Sp. Atk."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ASTRAL_BARRAGE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("SpctrlBrrage", "Spectral Barrage"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TERA_STARSTORM] =
    {
        ...
        .power = 120,
        .type = TYPE_ASTRAL, // Stellar type if used by Terapagos-Stellar
        .accuracy = 100,
        .pp = 5,
